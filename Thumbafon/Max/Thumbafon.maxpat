{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ -1003.0, 221.0, 787.0, 434.0 ],
		"bglocked" : 0,
		"defrect" : [ -1003.0, 221.0, 787.0, 434.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "/thum/interstitial \"Hey there! This might work...\"",
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"presentation_rect" : [ 463.0, 400.0, 0.0, 0.0 ],
					"patching_rect" : [ 474.0, 382.0, 259.0, 18.0 ],
					"fontname" : "Arial",
					"numinlets" : 2,
					"id" : "obj-2"
				}
...
, 							{
								"box" : 								{
									...
									"fontsize" : 12.0,
									"outlettype" : [ "int", "", "" ],
									"items" : [ "10.0.1.17", ",", "fe80:0:0:0:226:bbff:fe0c:bd5e%5" ],

{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ -1270.0, 533.0, 894.0, 397.0 ],
		"bglocked" : 0,
		"defrect" : [ -1270.0, 533.0, 894.0, 397.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "guard against duplicate ips",
					"linecount" : 2,
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 0,
					"presentation_rect" : [ 710.0, 40.0, 160.0, 20.0 ],
					"fontname" : "Arial",
					"patching_rect" : [ 890.0, 420.0, 150.0, 34.0 ],
					"presentation" : 1,
					"id" : "obj-51"
				}

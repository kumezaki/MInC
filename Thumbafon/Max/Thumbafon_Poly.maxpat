{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 236.0, 173.0, 400.0, 223.0 ],
		"bglocked" : 0,
		"defrect" : [ 236.0, 173.0, 400.0, 223.0 ],
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 881.0, 44.0, 205.0, 225.0 ],
						"bglocked" : 0,
						"defrect" : [ 881.0, 44.0, 205.0, 225.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "current offset",
									"patching_rect" : [ 99.0, 64.0, 80.0, 20.0 ],
									"numinlets" : 1,
									"fontsize" : 12.0,
									"numoutlets" : 0,
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 46.0, 85.0, 115.0, 20.0 ],
									"numinlets" : 1,
									"fontsize" : 12.0,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 46.0, 105.0, 112.0, 20.0 ],
									"numinlets" : 1,
									"fontsize" : 12.0,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
...
, 							{
								"box" : 								{
									"maxclass" : "message",
									"text" : "/thum/key $1",
									"patching_rect" : [ 46.0, 125.0, 79.0, 18.0 ],
									"numinlets" : 2,
									"fontsize" : 12.0,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
...
, 							{
								"box" : 								{
									"maxclass" : "outlet",
									"patching_rect" : [ 46.0, 171.0, 25.0, 25.0 ],
									"numinlets" : 1,
									"numoutlets" : 0,
									"id" : "obj-8",
									"comment" : ""
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"destination" : [ "obj-8", 0 ],
									"hidden" : 0,
									"midpoints" : [ 55.5, 143.0, 55.5, 143.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 55.5, 107.0, 55.5, 107.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"destination" : [ "obj-3", 0 ],
									"hidden" : 0,
									"midpoints" : [ 55.5, 125.0, 55.5, 125.0 ]
								}

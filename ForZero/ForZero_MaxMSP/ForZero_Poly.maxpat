{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 642.0, 315.0, 504.0, 430.0 ],
		"bglocked" : 0,
		"defrect" : [ 642.0, 315.0, 504.0, 430.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 63.0, 146.0, 33.0, 20.0 ],
					"outlettype" : [ "signal" ],
					"id" : "obj-4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 400.0, 148.0, 51.0, 18.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 305.0, 148.0, 43.0, 18.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-52"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 350.0, 148.0, 49.0, 18.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-41"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 305.0, 97.0, 30.0, 20.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-10",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"fontsize" : 12.0,
					"patching_rect" : [ 305.0, 123.0, 139.0, 20.0 ],
					"outlettype" : [ "", "", "", "", "" ],
					"id" : "obj-35"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 137.0, 327.0, 30.0, 20.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-11",
					"saved_object_attributes" : 					{
						"attr_comment" : ""
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"fontsize" : 12.0,
					"patching_rect" : [ 63.0, 350.0, 93.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 108.0, 381.0, 44.0, 20.0 ],
					"id" : "obj-6",
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 63.0, 59.0, 30.0, 20.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-26",
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"fontsize" : 12.0,
					"patching_rect" : [ 63.0, 85.0, 63.0, 20.0 ],
					"outlettype" : [ "", "" ],
					"id" : "obj-27"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 112.0, 152.0, 98.0, 20.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-25"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 63.0, 111.0, 20.0, 20.0 ],
					"outlettype" : [ "int" ],
					"id" : "obj-12"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"fontsize" : 12.0,
					"patching_rect" : [ 63.0, 190.0, 118.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"fontsize" : 12.0,
					"patching_rect" : [ 305.0, 189.0, 142.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 63.0, 381.0, 44.0, 20.0 ],
					"id" : "obj-2",
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-9", 0 ],
					"hidden" : 0,
					"midpoints" : [ 314.5, 177.5, 72.5, 177.5 ]
				}

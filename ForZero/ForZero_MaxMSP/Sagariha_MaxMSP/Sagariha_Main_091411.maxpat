{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 35.0, 79.0, 1115.0, 698.0 ],
		"bglocked" : 0,
		"defrect" : [ 35.0, 79.0, 1115.0, 698.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 875.0, 189.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 875.0, 214.0, 57.0, 18.0 ],
					"text" : "dump $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 719.0, 81.171051, 93.0, 20.0 ],
					"text" : "osc-route /saga"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 780.0, 188.0, 83.0, 20.0 ],
					"text" : "js Sagariha.js"
				}
